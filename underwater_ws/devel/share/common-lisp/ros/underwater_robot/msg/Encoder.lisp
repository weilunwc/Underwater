...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_robot-msg:<Encoder> is deprecated: use underwater_robot-msg:Encoder instead.")))

(cl:ensure-generic-function 'encoder_angle-val :lambda-list '(m))
(cl:defmethod encoder_angle-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder_angle-val is deprecated.  Use underwater_robot-msg:encoder_angle instead.")
  (encoder_angle m))

(cl:ensure-generic-function 'encoder_speed-val :lambda-list '(m))
(cl:defmethod encoder_speed-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder_speed-val is deprecated.  Use underwater_robot-msg:encoder_speed instead.")
  (encoder_speed m))
