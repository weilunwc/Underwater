...
int main(int argc ,char **argv){
    ...
    mot1_pub = n.advertise<underwater_msgs::Cmd>("/motor_1",10);
    mot2_pub = n.advertise<underwater_msgs::Cmd>("/motor_2",10);
    mot3_pub = n.advertise<underwater_msgs::Cmd>("/motor_3",10);
    center_pub = n.advertise<underwater_msgs::Cmd>("center_motor",10);
