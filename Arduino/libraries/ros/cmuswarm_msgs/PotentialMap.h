#ifndef _ROS_cmuswarm_msgs_PotentialMap_h
#define _ROS_cmuswarm_msgs_PotentialMap_h
...
namespace cmuswarm_msgs
{
  ...
  class PotentialMap : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cmuswarm_msgs/PotentialMap"; };
    const char * getMD5(){ return "fc44c16951d3421e6320cdbef3bb75d3"; };
