...
class SetupRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetupRequest
    // Serialize message field [dummy]
    bufferOffset = _serializer.bool(obj.dummy, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetupRequest
    let len;
    let data = new SetupRequest(null);
    // Deserialize message field [dummy]
    data.dummy = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetupRequest(null);
    if (msg.dummy !== undefined) {
      resolved.dummy = msg.dummy;
    }
    else {
      resolved.dummy = false
    }
...
class SetupResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetupResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetupResponse
    let len;
    let data = new SetupResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetupResponse(null);
...
module.exports = {
  ...
  md5sum() { return '81bdda0e5e12240216c90fa743ee071e'; },
  datatype() { return 'underwater_robot/Setup'; }
};
