...
(cl:defmethod cl:initialize-instance :after ((m <Imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_msgs-msg:<Imu> is deprecated: use underwater_msgs-msg:Imu instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msgs-msg:roll-val is deprecated.  Use underwater_msgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msgs-msg:pitch-val is deprecated.  Use underwater_msgs-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msgs-msg:yaw-val is deprecated.  Use underwater_msgs-msg:yaw instead.")
  (yaw m))
