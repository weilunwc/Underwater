...
class ARMarkers {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.markers.forEach((val) => {
      bufferOffset = ARMarker.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.markers[i] = ARMarker.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.markers.forEach((val) => {
      length += ARMarker.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ARMarkers(null);
    ...
    if (msg.markers !== undefined) {
      ...
      for (let i = 0; i < resolved.markers.length; ++i) {
        resolved.markers[i] = ARMarker.Resolve(msg.markers[i]);
      }
    }
    else {
      resolved.markers = []
