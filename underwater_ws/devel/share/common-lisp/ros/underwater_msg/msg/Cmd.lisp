...
(cl:defmethod cl:initialize-instance :after ((m <Cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_msg-msg:<Cmd> is deprecated: use underwater_msg-msg:Cmd instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msg-msg:mode-val is deprecated.  Use underwater_msg-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'spinning_speed-val :lambda-list '(m))
(cl:defmethod spinning_speed-val ((m <Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msg-msg:spinning_speed-val is deprecated.  Use underwater_msg-msg:spinning_speed instead.")
  (spinning_speed m))

(cl:ensure-generic-function 'flipping_angle-val :lambda-list '(m))
(cl:defmethod flipping_angle-val ((m <Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msg-msg:flipping_angle-val is deprecated.  Use underwater_msg-msg:flipping_angle instead.")
  (flipping_angle m))

(cl:ensure-generic-function 'flipping_speed-val :lambda-list '(m))
(cl:defmethod flipping_speed-val ((m <Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msg-msg:flipping_speed-val is deprecated.  Use underwater_msg-msg:flipping_speed instead.")
  (flipping_speed m))
