...
(cl:defmethod cl:initialize-instance :after ((m <Euler>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Euler)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_robot-msg:<Euler> is deprecated: use underwater_robot-msg:Euler instead.")))
