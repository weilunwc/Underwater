#ifndef _ROS_underwater_msg_Baro_h
#define _ROS_underwater_msg_Baro_h
...
namespace underwater_msg
{
  ...
  class Baro : public ros::Msg
  {
    ...
    const char * getType(){ return "underwater_msg/Baro"; };
    const char * getMD5(){ return "b11505eab6c52277745b4ae83c35f503"; };
