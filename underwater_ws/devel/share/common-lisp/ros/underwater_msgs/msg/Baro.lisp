...
(cl:defmethod cl:initialize-instance :after ((m <Baro>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Baro)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_msgs-msg:<Baro> is deprecated: use underwater_msgs-msg:Baro instead.")))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <Baro>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msgs-msg:depth-val is deprecated.  Use underwater_msgs-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'temp-val :lambda-list '(m))
(cl:defmethod temp-val ((m <Baro>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_msgs-msg:temp-val is deprecated.  Use underwater_msgs-msg:temp instead.")
  (temp m))
