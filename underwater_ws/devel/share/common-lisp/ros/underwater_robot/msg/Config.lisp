...
(cl:defmethod cl:initialize-instance :after ((m <Config>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Config)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name underwater_robot-msg:<Config> is deprecated: use underwater_robot-msg:Config instead.")))

(cl:ensure-generic-function 'imu-val :lambda-list '(m))
(cl:defmethod imu-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:imu-val is deprecated.  Use underwater_robot-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'barometer-val :lambda-list '(m))
(cl:defmethod barometer-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:barometer-val is deprecated.  Use underwater_robot-msg:barometer instead.")
  (barometer m))

(cl:ensure-generic-function 'encoder1-val :lambda-list '(m))
(cl:defmethod encoder1-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder1-val is deprecated.  Use underwater_robot-msg:encoder1 instead.")
  (encoder1 m))

(cl:ensure-generic-function 'encoder2-val :lambda-list '(m))
(cl:defmethod encoder2-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder2-val is deprecated.  Use underwater_robot-msg:encoder2 instead.")
  (encoder2 m))

(cl:ensure-generic-function 'encoder3-val :lambda-list '(m))
(cl:defmethod encoder3-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder3-val is deprecated.  Use underwater_robot-msg:encoder3 instead.")
  (encoder3 m))

(cl:ensure-generic-function 'encoder1_offset-val :lambda-list '(m))
(cl:defmethod encoder1_offset-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder1_offset-val is deprecated.  Use underwater_robot-msg:encoder1_offset instead.")
  (encoder1_offset m))

(cl:ensure-generic-function 'encoder2_offset-val :lambda-list '(m))
(cl:defmethod encoder2_offset-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder2_offset-val is deprecated.  Use underwater_robot-msg:encoder2_offset instead.")
  (encoder2_offset m))

(cl:ensure-generic-function 'encoder3_offset-val :lambda-list '(m))
(cl:defmethod encoder3_offset-val ((m <Config>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader underwater_robot-msg:encoder3_offset-val is deprecated.  Use underwater_robot-msg:encoder3_offset instead.")
  (encoder3_offset m))
